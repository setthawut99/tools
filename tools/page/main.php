                    ...
                    <div class="span9">
                        <div class="content">
							...
							<div class="module-body">
							    <div id="alerts"></div>
								<a class="btn btn-large btn-danger btn-block" id="onclick_checktoken" style="font-family: 'Kanit', sans-serif;" onclick="checktoken();" data-loading-text="<i class='fa fa-refresh fa-spin' aria-hidden='true'></i> โปรดรอสักครู่ระบบกำลังทำรายการ . . ."><i class="fa fa-star-o" aria-hidden="true"></i> กดที่นี้เพื่อตรวจสอบ Token</a>
								</br>
								<div class="control-group" style="text-align:center;">
									<label class="control-label" style="text-align:center;font-family: 'Kanit', sans-serif;">ป้อน Token ลงในช่องด่านล่าง</label>
									<div class="controls" style="text-align:center;">
										<textarea class="span8" id="text_token" rows="5"></textarea>
									</div>
									<a class="btn btn-large btn-success" id="onclick_addtoken" style="font-family: 'Kanit', sans-serif;" onclick="addtoken();" data-loading-text="<i class='fa fa-refresh fa-spin' aria-hidden='true'></i> โปรดรอสักครู่ระบบกำลังทำรายการ . . ."><i class="fa fa-star-o" aria-hidden="true"></i> เพิ่ม Token</a>
								</div>
							</div>
						</div>
                        </div>
