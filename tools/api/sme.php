...
foreach ($innodb as $token){
	    $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://graph.facebook.com/me/feed?link=https://www.facebook.com/".$_POST['idpost']."&message=".urlencode("#".$bclass->random(rand(10,20)))."&method=post&access_token=".urlencode($token));
